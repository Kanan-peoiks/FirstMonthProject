...
public class test12 {
        public static void main(String[] args) {
            ...
            for (int k = 0;k < 3; k++) {
                ...
                int rand =(int)( Math.random() * ortaSuallar.length-1 ); //RANDOM SUAL VERMESI UCUN
                ...
                while (true){
                    if (usedOrta[rand]){
                        rand =(int)( Math.random() * ortaSuallar.length-1 );
                        System.out.println(rand);}
                    else {
                        usedOrta[rand]=true;
                        break;}}
...
//CAVABIN DOGRULUGUNU YOXLAMAQ
            ...
            System.out.println("Yeni mərhələdə əlavə bir Jokeriniz olacaq, bir ədəd 'Hint' Jokeri.\n" +
                    "Joker haqqında məlumat: 'Hint' Jokeri sualdakı cavabı tapmağa ipucu verir.");
